...
object Constants {
    ...
    const val EMPTY_FIELD_ERROR = "Field Cannot be left blank!!!"
    const val INVALID_EMAIL_FORMAT_ERROR = "Invalid email address!!"
    const val MIN_NAME_ERROR = "min name length 4!!!"
